...
<head>
  ...
  <title>GIJO AS Lite — GIJO WIKI Edition v5.2.0 (초경량 올인원 보안 워크스페이스)</title>
    ...
    <div class="header-inner">
      <div class="brand-section">
        ...
        <div class="brand-text">
          GIJO AS Lite <span class="version-tag">WIKI v5.2</span>
        </div>
      ...
      <div class="wiki-grid">
        ...
        <aside class="white-panel">
          <div class="panel-head">
            ...
            <span style="font-size:0.68rem; color:var(--success); background:#ecfdf5; padding:0.15rem 0.45rem; border-radius:12px; border:1px solid #a7f3d0; font-weight:700; display:inline-flex; align-items:center; gap:4px;">
              <span style="width:6px; height:6px; background:#10b981; border-radius:50%; display:inline-block;"></span> GB10 / 에어갭 하이브리드
            </span>
          </div>
          ...
          <div class="chat-stream-box" id="ragChatMessages">
            <div class="bubble ai">
              👋 안녕하세요! <b>차세대 GIJO AS Lite (GIJO WIKI Edition)</b>에 오신 것을 환영합니다.<br>
              사내 공식 원본 지식고 9종(96,847자) 기반으로 에어갭 오프라인 검색과 GB10(177B) 고출력 추론을 원문 출처와 함께 지원합니다.
            </div>
          </div>
