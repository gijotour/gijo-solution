// ★ 사본(2026-09-03 프롬프트 실험) — 원본 run-r2.mjs은 손대지 않았다. 바뀐 곳: --models 옵션 · withSystem(모델 항목 system을 과제 system 앞에 합침) · m.warmup이면 워밍업 1회 버림.
...
// 사용:  node run-r2.mjs [--only id1,id2] [--port 8093] [--ctx 65536] [--out results-r2]
//        tasks-r2.mjs(2회차 문항)를 쓴다. models.json이 후보 목록의 단일 출처다(경로·thinking·추가 인자).
...
import { TASKS, 한글비율, 한자수 } from "./tasks-r2.mjs";
...
const OUT = path.resolve(here, opt("--out", "results-r2"));
