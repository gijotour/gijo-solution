# 증류 사다리 게이트 — r2-v2-ep2 · **불합격**

잰 때 2026-09-04T15:24:40.406Z · needle_64k 제외
...
| ✅ | 13과제 평균 (needle_64k 제외 → 12과제) | 0.871 | 기준선 0.867 초과 | needle_64k는 ctx 초과라 양쪽 0 — 빼고 잰다(넣어도 순위는 안 바뀌고 평균만 낮아진다) |
| ✅ | 잘린 답(베이스 대비 증가 0) | 증가 -4건 (이번 1건 · 베이스 5건) | 베이스보다 늘지 않는다 | 자리별 이번/베이스 — easy 0/0 · hard 0/0 · grounded 0/0 · distractor-only 0/0 · bare 1/5. 절대 0건은 **베이스가 못 넘는 기준**이었다(bare 5건 — 시스템 프롬프트 없이 900토큰 상한). 그 기준은 답이 짧아질수록 초록이 되어 ⑪의 표적에 상을 준다 |
...
| ✅ | 서술 답 길이 낙폭 (report_draft·report_fix·glossary_cite) | -51.2% (중앙값 387 토큰) | 기준선 256 토큰 대비 40% 이내 | 점수는 그대로인데 답만 짧아지는 회귀가 실제로 났다(34~72%). 스키마 강제 과제는 길이가 스키마에 눌려 안 드러나므로 뺐다: priority_rank·priority_6·scan_messy |
| ❌ | 베낀 글자 비율(통째 복사 아님) | 평균 86% · 통째 복사 0건 / 8 | 평균 60% 이하 · 통째 복사 0건 | 베이스 평균 20% · 통째 0건 / ⑧은 20자 창이 하나만 남아도 100%가 되므로 **통째 복사로도 만점**이다 — 그래서 둘을 함께 읽는다 |
...
- 원천: /home/gijohn_llm/gijo-as/tools/team-bench/results-ladder/day2/r2-v2/ep2/easy/qwen3-14b+r2-v2-ep2.json
- 원천: /home/gijohn_llm/gijo-as/tools/team-bench/results-ladder/day2/r2-v2/ep2/hard/qwen3-14b+r2-v2-ep2.json
- 원천: /home/gijohn_llm/gijo-as/tools/team-bench/results-ladder/day2/r2-v2/ep2/samples-grounded.json
- 원천: /home/gijohn_llm/gijo-as/tools/team-bench/results-ladder/day2/r2-v2/ep2/samples-distractor-only.json
- 원천: /home/gijohn_llm/gijo-as/tools/team-bench/results-ladder/day2/r2-v2/ep2/samples-bare.json
- 원천: /home/gijohn_llm/gijo-as/tools/team-bench/results-ladder/day2/r2-v2/ep2/samples-persona.json
- 원천: /home/gijohn_llm/gijo-as/tools/team-bench/results-ladder/day2/r2-v2/ep2/kev.json
