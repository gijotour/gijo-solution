...
export const 승인된겹침 = [
  ...
  },
  {
    ...
    이김: "검증(하드닝) 현황",
    밀림: "강제 도구",
    이유: "「결과 알려줘」는 **조회**지 실행이 아니다 — 물었다고 점검을 새로 돌리면 시키지 않은 " +
          "작업을 하는 것이고, 사람이 기다리던 지난 결과도 못 본다.",
    승인일: "2026-09-05",
    승인자: "사장님",
  },
  {
    ...
    이김: "검증(하드닝) 현황",
    밀림: "강제 도구",
    이유: "위와 같은 말을 다르게 부른 것뿐이다 — 「결과」를 물으면 현황 카드가 맞다. " +
          "run_hardening_scan은 사람이 「점검 돌려줘」라고 **시켰을 때** 갈 자리다.",
    승인일: "2026-09-05",
    승인자: "사장님",
  },
  {
