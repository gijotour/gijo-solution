...
// ★ 2026-09-11: **6종**이 됐다(온톨로지전용 — B1 확장의 짝인 B2. 사내 문서 근거는 없지만
//   온톨로지(제품 내장 지식 그래프)가 원천인 답에 붙는다). 이 배너에도 「없습니다」가 들어
//   있어, 안 떼면 2026-08-14·09-05·09-06에 세 번 막은 자동통과가 또 열린다.
const 배너_RE = /^\s*⚠\s*\*\*(근거 약함|이 PC의 사내 자료에는|지정하신 문서 범위에서는|이건 우리 회사 고유 정보|사내 자료에 없는 수치|사내 문서 근거는 없습니다)[^\n]*\n+/;
