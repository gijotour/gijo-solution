...
async function runClient() {
  ...
  await scenario("QA-C05", "전체메뉴", "9그룹 — 절차 5허브 + 기반 4그룹", {
    ...
    const 기대항목 = ["대시보드", "팀 사무실 (창)", "문서 작성 (창) · 무료", "작업 내역", "보안 로그 파일 분석", "법령·판례", "제품 소개자료", "업무 넘기기", "설정", "기록"];
    ...
    // 2026-08-14: 「문서 작성 (창)」(무료 Smart MD)이 더해져 **4자리**가 됐다(사장님 지시).
    ...
    for (const 있어야 of ["대시보드", "팀 사무실", "문서 작성", "작업 내역"]) {
