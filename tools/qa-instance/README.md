...
- 건너뛴 문항은 **대상에서 빼지 않는다** — 결과 줄로 남고(`건너뜀` 사유가 찍힌다), 통과율
  ...
  09-12·09-13 실제 야간 두 회차 모두 **199/199 · 건너뜀 6(법령 5 자동 감지·업무 1)**이었다
  (`GIJO_AS_AI팀_증류학습_계획서.md` 2026-09-12·09-13 줄). 2026-09-13 SLA/라우팅 라운드 ⑤가
  업무 표식 1개(「10.0.0.100 에 뭐가 있어?」 — 4100에서도 「자산」 갈래로 통과해 데이터 의존이
  아니었다)를 빼면서 업무 1이 0이 되어, 지금부터는 **200/200 · 건너뜀 5(법령 5)**가 맞다.
