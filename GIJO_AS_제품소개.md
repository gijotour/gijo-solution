# GIJO AS — 제품 소개 자료 (v1.0.0)

> **한 명의 보안담당자가 여러 명 몫을 해내도록.**
> 쏟아지는 보안 정보를 AI 에이전트가 **자동으로 엮어** 처리하는 온프레미스 보안 운영 플랫폼.

*본 자료의 모든 수치·예시·**스크린샷**은 v1.0.0을 실제 구동해 뽑은 **실측 백데이터**입니다(서버 자동화 테스트 243개 통과).*
...
| **품질** | 서버 자동화 테스트 **243개 통과**, 38개 엔진 모듈, 실기동 엔드투엔드 검증 |
...
아래 10장은 **실제 제품 화면**을 실측 서버 응답 데이터로 렌더링한 것입니다(1440×960, 2배 해상도).

| 파일 | 화면 | 보이는 실측 데이터 |
|---|---|---|
| `01-보안KPI대시보드.png` | 보안 KPI | 자산3·점검6(지연1)·CTI영향자산3·KISA21 |
...
*문서 버전: v1.0.0 · 데이터 기준일: 2026-07-16 · 수치·스크린샷 모두 실제 서버 구동 결과.*
