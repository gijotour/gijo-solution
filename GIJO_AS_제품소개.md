...
> 이 관문들은 **2026-08-08 실사고**에서 나왔습니다. 저장소 조각의 73%가 읽을 수 없는 상태였는데
> 숫자로는 정상으로 보였습니다. 지금은 그런 문서가 들어오면 **넣는 순간 오류로 알립니다.**
...
> ⚠ **스크린샷은 v2.x 시절 것입니다.** 그 뒤 메뉴가 **업무 절차 5단계 허브**로 개편됐고(4.15),
> 화면 위쪽에 「한눈에 띠」가 생겼습니다. 지금 화면과 다르게 보이는 것은 그 때문입니다 —
> 최신 화면 캡처는 다음 갱신 때 교체합니다. **기능 설명(4장)은 현재 제품 기준입니다.**
...
*문서 버전: **v5.11.0** · 데이터 기준일: 2026-08-08 · 수치는 실제 서버 구동 결과(자동화 시험 2,748개 통과).*
*스크린샷은 v2.x 기준이라 현재 메뉴 구조(절차 5단계 허브)와 다릅니다 — 캡처 교체는 다음 갱신 예정.*
