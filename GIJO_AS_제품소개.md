...
데이터도 AI도 폐쇄망(온프레미스) 안에서만 돕니다. 밖으로 나가는 것이 없습니다.
...
| 전-3 | 학습 후보함 완성 — "쓸수록 똑똑해지는 제품"의 첫 조각 | ✅ 완료 (2026-08-17) |
| 전-4 | **기본 지식 번들 v1** — 6대 표준+지식 시드에 버전을 붙여 오프라인 갱신 배포 | ✅ 완료 (2026-08-17 — 버전 2026.07-1·부팅 자동적용·Ed25519 서명 반입, vitest 5파일. 정찰 전수 확인. 유상 구독화는 후-3 별개) |
