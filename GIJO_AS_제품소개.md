# GIJO AS — 제품 소개 자료 (v5.12.0)

> **한 명의 보안담당자가 여러 명 몫을 해내도록.**
> 쏟아지는 보안 정보를 AI 에이전트가 **자동으로 엮어** 처리하는 온프레미스 보안 운영 플랫폼.

*본 자료의 모든 수치·예시·**스크린샷**은 실제 구동해 뽑은 **실측 백데이터**입니다(서버 자동화 시험 **2,748개** 통과).*
...
> 스크린샷은 **현재 제품(5.11.0) 화면**입니다 — 업무 절차 5단계 허브·추가 기능 메뉴가 그대로 보입니다.
...
*문서 버전: **v5.12.0** · 데이터 기준일: 2026-08-09 · 수치는 실제 서버 구동 결과(자동화 시험 2,780개 통과).*
*스크린샷은 2026-08-09 현재 화면으로 다시 촬영했습니다(실측 데이터 렌더링 — 목업 아님).*
