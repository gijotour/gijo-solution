...
// (스캔 해석 초안 조회 API는 두지 않는다 — 부르는 클라가 0곳이었다. 초안은 대화창 도구 scan_drafts로 본다. 검토관 2026-09-03)
...
export function createApp(): Express {
  ...
  대화수집_배선();   // ⚠ 등록 없으면 학습 후보가 안 쌓인다
  기억성장_배선();   // ⚠ 등록 없으면 승인해도 기억이 안 자란다(학습 재료로만 쌓인다). 라우트 전후 어디든 무방하다 ⚠ 라우트 등록보다 먼저 — 부팅 중 들어온 스캔도 배정되게
