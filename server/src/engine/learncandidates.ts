...
// ★ 2026-09-06 — 배너가 **다섯째**(숫자무근거)로 늘면서 이 판별의 그물도 함께 넓어졌다.
//   부분 접지 답(백분율 넷은 문서에 있고 하나만 지어낸 답)도 이제 배너를 받으므로 cite=false가
//   되어 score 4→1, 후보함(minScore 3)에서 빠진다. **의도한 결과다** — 지어낸 숫자가 한 개라도
