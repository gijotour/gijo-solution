...
//   ⚠ 「유일하게 높을수록 좋다」는 **모의훈련 지표 안에서만** 참이다 — 참여율·이수율·응답률도
//     높을수록 좋다. 문서(§📖 용어 풀이)가 같은 단서를 달고 있으니 함께 고칠 것.
export const DOMAIN_SENSE: Record<string, string> = {
  ...
  "신고율": "피싱 모의훈련에서 훈련 메일을 신고 창구로 알린 대상자 비율(모의훈련 지표 중 유일하게 높을수록 좋다 — 클릭률과 반대 방향이라 함께 본다). 범죄·민원·세금 신고율이 아닙니다.",
