...
const 선택배선대장: Record<string, "부품" | "직접" | ["제외", string]> = {
  ...
  "threat.html": ["제외", "B16 잔여 — CTI 탐지 목록 선택 미배선(대상이 도메인·이메일이라 자산 매칭 설계 필요)"],
  ...
  "compliance.html": ["제외", "B16 잔여 — 위협코드 행 선택 미배선"],
  "handover.html": ["제외", "B16 잔여 — 단계 위저드 화면이라 고를 목록이 얇음(검토 후 결정)"],
  "products.html": ["제외", "B16 잔여 — 제품 행 선택 미배선(제품용 제안 칩 설계 필요)"],
  "maintenance.html": ["제외", "B16 잔여 — 점검 행 선택 미배선"],
  "intro.html": ["제외", "B16 잔여 — 소개자료 행 선택 미배선"],
  "sessions.html": ["제외", "B16 잔여 — 작업 내역 행 선택 미배선(이어서 지시하기 버튼이 대행)"],
  "lawlookup.html": ["제외", "결과가 대화창 답으로 오는 화면 — 고를 목록이 화면에 없음"],
  "kpi.html": ["제외", "숫자 대시보드 — 고를 항목 없음"],
  "report.html": ["제외", "B16 잔여 — 리포트 행 선택 미배선"],
  ...
  "inventory.html": ["제외", "B16 잔여 — 자산 관리 행 선택 미배선(자산 고르기(assets)가 그 역할 대행)"],
  "hardening.html": ["제외", "B16 잔여 — 점검 대상 행 선택 미배선"],
  "memory.html": ["제외", "B16 잔여 — 문서 행 선택 미배선(문서용 카드·칩 설계 필요)"],
  "learnloop.html": ["제외", "B16 잔여 — 학습 후보 선택 미배선(후보용 픽리스트 설계 필요)"],
