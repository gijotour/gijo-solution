...
const BATCHES = [
  ...
  { key: 'D5', label: '설치·배포·머신 환경', files: ['GIJO_AS_설치_가이드_v2.1.0.md', 'GIJO_AS_클라이언트_배포_가이드.md', 'GIJO_AS_배포_가이드.md', 'GIJO_AS_PC세팅_체크리스트.md', 'GIJO_AS_WSL2_서버이전_계획서.md', 'GIJO_AS_2머신_개발환경_가이드.md', 'GIJO_AS_MAC_올인원_배포_가이드.md', 'GIJO_AS_MAC_M4_24GB_구성안.md', 'GIJO_AS_MAC_QA_계획.md'] },
